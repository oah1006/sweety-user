      ...
      <div class="flex items-center gap-3">
        ...
        <div class="relative">
          <div v-if="!isModalRequireLogin">
            <svg @click="redirectCart" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-8 h-8 text-zinc-700 cursor-pointer">
