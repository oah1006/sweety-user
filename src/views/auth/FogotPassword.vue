<template>
  <div class="z-60 relative overflow-hidden bg-[url('./public/images/coffee-shop-5.jpg')] w-full flex items-center justify-center min-h-screen bg-no-repeat bg-contain bg-cover bg-right">
